# summarization/pegasus_runner.py
...
def run(in_csv="data/guardian_articles_raw.csv", out_jsonl="outputs/pegasus.jsonl", limit=0):
        ...
        for i, title, body, domain, url in tqdm(iter_articles(in_csv, limit=limit)):
            ...
            for style in STYLES:
                ...
                write_record(out, {
                    ...
                    "model": "PEGASUS-cnn_dailymail", "style": style, "title": title, "summary": s
                })
